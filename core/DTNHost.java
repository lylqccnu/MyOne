...
public class DTNHost implements Comparable<DTNHost> {
	...
	/**返回当前节点正在使用的路径，如果当前没有使用路径则返回null
	...
	public int getMessageSize() {
		return this.router.getMessagesSize();
	}
	...
	public double getBufferOccupancy() {
		double bSize = router.getBufferSize();	//获取缓存大小
		double freeBuffer = router.getFreeBufferSize();	//获取剩余缓存大小
